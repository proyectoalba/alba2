...
CREATE  TABLE IF NOT EXISTS `alba2`.`dependencia_organizativa` (
  ...
  `dependencia_padre_id` INT(11) NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `alba2`.`establecimiento` (
  ...
  `dependencia_organizativa_id` INT(11) NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `alba2`.`plan_estudio` (
  ...
  `estado_id` INT(11) NOT NULL ,
  `plan_estudio_origen_id` INT(11) NULL DEFAULT NULL COMMENT 'Indica el plan de estudios original\nen caso de que el actual haya sido \ncreado a partir de otro existente.' ,
...
CREATE  TABLE IF NOT EXISTS `alba2`.`responsable_alumno` (
  ...
  `nivel_instruccion_alcanzado_id` INT(11) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `alba2`.`inscripcion` (
  ...
  `plan_estudio_id` INT(11) NOT NULL ,
  `anio_id` INT(11) NOT NULL ,
  `turno_id` INT(11) NOT NULL COMMENT 'Turno de preferencia\n' ,
  `ciclo_lectivo_id` INT(11) NOT NULL ,
  `estado_id` INT(11) NOT NULL ,
  `sede_id` INT(11) NOT NULL ,
  `condicion_id` INT(11) NULL COMMENT 'Por ejemplo si es \nhermano de un alumno\nactual o hijo de \nun docente' ,
  `fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
...
CREATE  TABLE IF NOT EXISTS `alba2`.`designacion_docente` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `docente_id` INT(11) NOT NULL ,
  `plan_estudio_asignatura_id` INT(11) NOT NULL ,
  `tipo_designacion_id` INT(11) NOT NULL COMMENT '- Titular\n- Interino\n- Suplente' ,
  `fecha_inicio` DATE NULL ,
  `fecha_fin` DATE NULL ,
  `estado_id` INT(11) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `alba2`.`ficha_salud` (
  ...
  `estado_vacunacion_id` INT(11) NULL ,
...
CREATE  TABLE IF NOT EXISTS `alba2`.`contacto_emergencia` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `ficha_salud_id` INT(11) NOT NULL ,
  `tipos_contacto_id` INT(11) NOT NULL ,
